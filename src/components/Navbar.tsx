        ...
        <div className="flex gap-4">
          {navbarMenu &&
            navbarMenu.pageLinks.map((item: any) => (
              <div
                key={item.link}
                className="font-calistoga text-zinc-700 relative after:content-[''] after:block after:border-b after:border-light-primary after:top-2 after:scale-x-0 hover:after:scale-x-100 after:origin-center after:transition-transform after:duration-200"
              >
                <Link
